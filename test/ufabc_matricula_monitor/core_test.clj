...
(deftest parse-response
  (is (match? (m/equals {"2034" ["8992"], "4994" ["8595" "8492"], "526" ["8417" "8662" "9190"]})
              (core/parse-response matriculas-sample))
      "Can parse matriculas")

  (is (match? (m/equals {"8682" "94", "8623" "1", "8290" "77"})
              (core/parse-response contagem-matriculas-sample))
      "Can parse contagem matriculas")
  ...
  (is (match? (m/embeds [{"vagas" 86,
                          ...
                          "codigo" "ESTS016-17"}])
              (core/parse-response todas-disciplinas-sample))
      "Can parse todas disciplinas"))
